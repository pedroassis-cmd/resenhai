...
export const rsvpService = {
  ...
  /**
   * Admin: marca o jogador como ausente (não compareceu).
   * O status NO_SHOW pode ser usado para estatísticas de confiabilidade.
   *
   * @param {string} matchId
   * @param {string} userId  - ID do jogador ausente
  ...
  /**
   * Admin: confirma a presença de um suplente convidado (INVITED → CONFIRMED).
   * Usado quando o suplente chega ao local e o admin confirma manualmente.
   *
   * @param {string} matchId
   * @param {string} userId  - ID do suplente
   * @returns {Promise<object>}
   */
